name: "Feature request: GitHub as AI Infrastructure (.GITOPENCLAW)"
description: Propose a new capability leveraging GitHub as native AI agent infrastructure.
title: "[Feature]: GitHub as AI Infrastructure — .GITOPENCLAW native support in OpenClaw"
labels:
  - enhancement
body:
  - type: markdown
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: Other approaches you have tried or considered and why they fall short.
      value: |
  ...
  - type: textarea
    ...
    attributes:
      ...
      description: Anything else — screenshots, logs, links to related issues or discussions.
      value: |
